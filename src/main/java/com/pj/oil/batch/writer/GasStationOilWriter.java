...
public class GasStationOilWriter implements ItemWriter<GasStationOilDto> {
    ...
    @Override
    public void write(Chunk<? extends GasStationOilDto> chunk) throws Exception {
        List<? extends GasStationOilDto> items = chunk.getItems(); // Chunk에서 아이템 리스트를 가져옴
        ...
        jdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps, int i) throws SQLException {
                GasStationOilDto item = items.get(i);
