...
public class LowTop20PriceWriter implements ItemWriter<LowTop20PriceDto> {
    ...
    @Override
    public void write(Chunk<? extends LowTop20PriceDto> chunk) throws Exception {
        List<? extends LowTop20PriceDto> items = chunk.getItems(); // Chunk에서 아이템 리스트를 가져옴
        ...
        jdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps, int i) throws SQLException {
                LowTop20PriceDto item = items.get(i);
