...
//
//
//public class AverageSidoPriceProcess implements ItemProcessor<AreaAverageRecentPriceDto, AreaAverageRecentPrice>{
//
//    private final CacheService cacheService;
//
//    public AverageSidoPriceProcess(CacheService cacheService) {
