...
//
//
//public class AverageAllPriceProcess implements ItemProcessor<AreaAverageRecentPriceDto, AreaAverageRecentPrice>{
//
//    private final CacheService cacheService;
//
//    public AverageAllPriceProcess(CacheService cacheService) {
